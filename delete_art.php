...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['proses']) && $_POST['proses'] === 'Hapus') {
    $delete_sql = "DELETE FROM si_art WHERE id_art = '$id_art'";
    ...
    if ($delete_query) {
        ...
        echo "Gagal menghapus data siswa. Error: " . mysqli_error($conn);
    }
}
?>
<style>
    ...
    <form method="post" action="">
        <table>
            <tr>
                <td>Id Art</td>
                <td>:</td>
                <td><input type="text" name="id_art" value="<?php echo isset($data['id_art']) ? $data['id_art'] : ''; ?>" readonly></td>
            </tr>
            <tr>
    <td>Nama</td>
    <td>:</td>
...
<td>
    ...
    <td> 
        <select name="berkendara">
            ...
            <tr>
                <td colspan="3"><input type="submit" name="proses" value="Hapus"></td>
            </tr>
        </table>
    </form>
    <p><a href="cari_art.php">Kembali ke Data Asisten Rumah Tanggat</a></p>
</body>
</html>